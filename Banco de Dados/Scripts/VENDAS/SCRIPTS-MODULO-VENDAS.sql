...
CREATE TABLE AVA_VENDA_VEN (
    ...
    VEN_DATACRIACAO DATETIME2(7) NOT NULL,
	VEN_DATAATUALIZACAO DATETIME2(7),
    VEN_VALORTOTAL DECIMAL(18, 2),
	VEN_STATUSPAGAMENTO INT NOT NULL,
    VEN_STATUSVENDA INT NOT NULL,
...
CREATE INDEX IDX_VENDA_VEN_DATAVENDA ON AVA_VENDA_VEN (VEN_DATACRIACAO);
...
CREATE TABLE AVA_ITEMVENDA_ITV (
	...
	ITV_NOMEPRODUTO VARCHAR2(200),
    ITV_QUANTIDADE INT NOT NULL,
    ITV_PRECOUNITARIO DECIMAL(18, 2),
